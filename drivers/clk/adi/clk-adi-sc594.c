...
#define CGU_DIVEX       0x40 //0x3108D040
...
#define CDU_CFG10    0x28 //0x3108F028
#define CDU_CFG11    0x2C //unused
#define CDU_CFG12    0x30 //0x3108F030
...
static const char *arm_sels[] = {"cclk1_0", "dummy", "dummy", "dummy"};
static const char *cdu_ddr_sels[] = {"dclk_0", "dclk_1", "dummy", "dummy"};
static const char *can_sels[] = {"oclk_0", "oclk_1", "dummy", "dummy"};
static const char *spdif_sels[] = {"sclk1_0", "dummy", "dummy", "dummy"};
static const char *spi_sels[] = {"sclk0_0", "oclk_0", "dummy", "dummy"};
static const char *gige_sels[] = {"sclk0_0", "sclk0_1", "cclk0_1", "dummy"};
static const char *lp_sels[] = {"oclk_0", "sclk0_0", "cclk0_1", "dummy"};
static const char *lpddr_sels[] = {"oclk_0", "dclk_0", "sysclkin_1", "dummy"};
static const char *ospi_sels[] = {"sysclk_0", "sclk0_0", "sclk1_1", "dummy"};
...
static int sc594_clock_probe(struct platform_device *pdev) {
	...
	clks[ADSP_SC594_CLK_DUMMY] = clk_register_fixed_rate(dev, "dummy", NULL, 0, 0);
	...
	clks[ADSP_SC594_CLK_CGU1_IN] = clk_register_mux(dev, "cgu1_in_sel",
		cgu1_in_sels, 2, CLK_SET_RATE_PARENT, cdu + CDU_CLKINSEL, 0, 1, 0,
		&cdu_lock);

	// CGU configuration and internal clocks
	clks[ADSP_SC594_CLK_CGU0_PLL_IN] = clk_register_divider(dev, "cgu0_df",
		"sys_clkin0", CLK_SET_RATE_PARENT, cgu0 + CGU_CTL, 0, 1, 0, &cdu_lock);
	clks[ADSP_SC594_CLK_CGU1_PLL_IN] = clk_register_divider(dev, "cgu1_df",
	...
	clks[ADSP_SC594_CLK_CGU1_PLLCLK] = clk_register_fixed_factor(dev,
		"cgu1_pllclk", "cgu1_vco", CLK_SET_RATE_PARENT, 1, 1);

	// Dividers from pll output
	clks[ADSP_SC594_CLK_CGU0_CDIV] = cgu_divider(dev, "cgu0_cdiv", "cgu0_pllclk",
		cgu0 + CGU_DIV, 0, 5, 0);
	clks[ADSP_SC594_CLK_CGU0_SYSCLK] = cgu_divider(dev, "sysclk_0", "cgu0_pllclk",
		cgu0 + CGU_DIV, 8, 5, 0);
	clks[ADSP_SC594_CLK_CGU0_DDIV] = cgu_divider(dev, "cgu0_ddiv", "cgu0_pllclk",
		cgu0 + CGU_DIV, 16, 5, 0);
	clks[ADSP_SC594_CLK_CGU0_ODIV] = cgu_divider(dev, "cgu0_odiv", "cgu0_pllclk",
		cgu0 + CGU_DIV, 22, 7, 0);
	clks[ADSP_SC594_CLK_CGU0_S0SELDIV] = cgu_divider(dev, "cgu0_s0seldiv",
		"sysclk_0", cgu0 + CGU_DIV, 5, 3, 0);
	clks[ADSP_SC594_CLK_CGU0_S1SELDIV] = cgu_divider(dev, "cgu0_s1seldiv",
	...
	clks[ADSP_SC594_CLK_CGU1_CDIV] = cgu_divider(dev, "cgu1_cdiv", "cgu1_pllclk",
		cgu1 + CGU_DIV, 0, 5, 0);
	clks[ADSP_SC594_CLK_CGU1_SYSCLK] = cgu_divider(dev, "sysclk_1", "cgu1_pllclk",
		cgu1 + CGU_DIV, 8, 5, 0);
	clks[ADSP_SC594_CLK_CGU1_DDIV] = cgu_divider(dev, "cgu1_ddiv", "cgu1_pllclk",
		cgu1 + CGU_DIV, 16, 5, 0);
	clks[ADSP_SC594_CLK_CGU1_ODIV] = cgu_divider(dev, "cgu1_odiv", "cgu1_pllclk",
		cgu1 + CGU_DIV, 22, 7, 0);
	clks[ADSP_SC594_CLK_CGU1_S0SELDIV] = cgu_divider(dev, "cgu1_s0seldiv",
		"sysclk_1", cgu1 + CGU_DIV, 5, 3, 0);
	clks[ADSP_SC594_CLK_CGU1_S1SELDIV] = cgu_divider(dev, "cgu1_s1seldiv",
	...
	clks[ADSP_SC594_CLK_CGU0_CCLK0] = cgu_gate(dev, "cclk0_0", "cgu0_cdiv",
		cgu0 + CGU_CCBF_DIS, 0);
	clks[ADSP_SC594_CLK_CGU0_CCLK1] = cgu_gate(dev, "cclk1_0", "cgu0_cdiv",
		cgu1 + CGU_CCBF_DIS, 1);
	clks[ADSP_SC594_CLK_CGU0_OCLK] = cgu_gate(dev, "oclk_0", "cgu0_odiv",
		cgu0 + CGU_SCBF_DIS, 3);
	clks[ADSP_SC594_CLK_CGU0_DCLK] = cgu_gate(dev, "dclk_0", "cgu0_ddiv",
		cgu0 + CGU_SCBF_DIS, 2);
	clks[ADSP_SC594_CLK_CGU0_SCLK1] = cgu_gate(dev, "sclk1_0", "cgu0_sclk1sel",
		cgu0 + CGU_SCBF_DIS, 1);
	clks[ADSP_SC594_CLK_CGU0_SCLK0] = cgu_gate(dev, "sclk0_0", "cgu0_s0seldiv",
		cgu0 + CGU_SCBF_DIS, 0);

	clks[ADSP_SC594_CLK_CGU1_CCLK0] = cgu_gate(dev, "cclk0_1", "cgu1_cdiv",
		cgu1 + CGU_CCBF_DIS, 0);
	clks[ADSP_SC594_CLK_CGU1_CCLK1] = cgu_gate(dev, "cclk1_1", "cgu1_cdiv",
		cgu1 + CGU_CCBF_DIS, 1);
	clks[ADSP_SC594_CLK_CGU1_OCLK] = cgu_gate(dev, "oclk_1", "cgu1_odiv",
		cgu1 + CGU_SCBF_DIS, 3);
	clks[ADSP_SC594_CLK_CGU1_DCLK] = cgu_gate(dev, "dclk_1", "cgu1_ddiv",
		cgu1 + CGU_SCBF_DIS, 2);
	clks[ADSP_SC594_CLK_CGU1_SCLK1] = cgu_gate(dev, "sclk1_1", "cgu1_sclk1sel",
		cgu1 + CGU_SCBF_DIS, 1);
	clks[ADSP_SC594_CLK_CGU1_SCLK0] = cgu_gate(dev, "sclk0_1", "cgu1_s0seldiv",
		cgu1 + CGU_SCBF_DIS, 0);

	// CDU output muxes
	clks[ADSP_SC594_CLK_SHARC0_SEL] = cdu_mux(dev, "sharc0_sel", cdu + CDU_CFG0,
		sharc0_sels);
	clks[ADSP_SC594_CLK_SHARC1_SEL] = cdu_mux(dev, "sharc1_sel", cdu + CDU_CFG1,
		sharc1_sels);
	clks[ADSP_SC594_CLK_ARM_SEL] = cdu_mux(dev, "arm_sel", cdu + CDU_CFG2,
		arm_sels);
	clks[ADSP_SC594_CLK_CDU_DDR_SEL] = cdu_mux(dev, "cdu_ddr_sel", cdu + CDU_CFG3,
		cdu_ddr_sels);
	clks[ADSP_SC594_CLK_CAN_SEL] = cdu_mux(dev, "can_sel", cdu + CDU_CFG4,
		can_sels);
	clks[ADSP_SC594_CLK_SPDIF_SEL] = cdu_mux(dev, "spdif_sel", cdu + CDU_CFG5,
		spdif_sels);
	clks[ADSP_SC594_CLK_RESERVED_SEL] = cdu_mux(dev, "spi_sel", cdu + CDU_CFG6,
		spi_sels);
	clks[ADSP_SC594_CLK_GIGE_SEL] = cdu_mux(dev, "gige_sel", cdu + CDU_CFG7,
		gige_sels);
	clks[ADSP_SC594_CLK_LP_SEL] = cdu_mux(dev, "lp_sel", cdu + CDU_CFG8, lp_sels);
	clks[ADSP_SC594_CLK_LPDDR_SEL] = cdu_mux(dev, "lpddr_sel", cdu + CDU_CFG9, lpddr_sels);
	clks[ADSP_SC594_CLK_OSPI_SEL] = cdu_mux(dev, "ospi_sel", cdu + CDU_CFG10, ospi_sels);
	clks[ADSP_SC594_CLK_TRACE_SEL] = cdu_mux(dev, "trace_sel", cdu + CDU_CFG12, trace_sels);

	// CDU output enable gates
	clks[ADSP_SC594_CLK_SHARC0] = cdu_gate(dev, "sharc0", "sharc0_sel",
		cdu + CDU_CFG0, CLK_IS_CRITICAL);
	clks[ADSP_SC594_CLK_SHARC1] = cdu_gate(dev, "sharc1", "sharc1_sel",
		cdu + CDU_CFG1, CLK_IS_CRITICAL);
	clks[ADSP_SC594_CLK_ARM] = cdu_gate(dev, "arm", "arm_sel", cdu + CDU_CFG2,
		CLK_IS_CRITICAL);
	clks[ADSP_SC594_CLK_CDU_DDR] = cdu_gate(dev, "cdu_ddr", "cdu_ddr_sel",
		cdu + CDU_CFG3, CLK_IS_CRITICAL);
	clks[ADSP_SC594_CLK_CAN] = cdu_gate(dev, "can", "can_sel", cdu + CDU_CFG4, 0);
	clks[ADSP_SC594_CLK_SPDIF] = cdu_gate(dev, "spdif", "spdif_sel", cdu + CDU_CFG5,
		0);
	clks[ADSP_SC594_CLK_SPI] = cdu_gate(dev, "spi", "spi_sel", cdu + CDU_CFG6, 0);
	clks[ADSP_SC594_CLK_GIGE] = cdu_gate(dev, "gige", "gige_sel", cdu + CDU_CFG7, 0);
	clks[ADSP_SC594_CLK_LP] = cdu_gate(dev, "lp", "lp_sel", cdu + CDU_CFG8, 0);
	clks[ADSP_SC594_CLK_LPDDR] = cdu_gate(dev, "lpddr", "lpddr_sel", cdu + CDU_CFG9, 0);
	clks[ADSP_SC594_CLK_OSPI] = cdu_gate(dev, "ospi", "ospi_sel", cdu + CDU_CFG10, 0);
	clks[ADSP_SC594_CLK_TRACE] = cdu_gate(dev, "trace", "trace_sel", cdu + CDU_CFG12, 0);
...
static const struct of_device_id sc594_clk_of_match[] = {
	{ .compatible = "adi,sc594-clocks" },
	{ },
};
MODULE_DEVICE_TABLE(of, sc594_clk_of_match);

static struct platform_driver sc594_clk_driver = {
	.probe = sc594_clock_probe,
	.driver = {
		.name = "sc594-clocks",
		.of_match_table = sc594_clk_of_match,
	},
};
module_platform_driver(sc594_clk_driver);
