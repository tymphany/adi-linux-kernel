...
struct adi_spi_transfer_ops {
	void (*write) (struct adi_spi_master *, struct spi_transfer *);
	void (*read) (struct adi_spi_master *, struct spi_transfer *);
	void (*duplex) (struct adi_spi_master *, struct spi_transfer *);
};
