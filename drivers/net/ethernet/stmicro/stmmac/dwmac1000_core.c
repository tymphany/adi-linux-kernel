			      ...
			      u32 high_credit, u32 low_credit, u32 queue)
{
	...
	printk(KERN_INFO "Queue %d configured as AVB. Parameters:\n", queue);
	printk(KERN_INFO "\tsend_slope: 0x%08x\n", send_slope);
	printk(KERN_INFO "\tidle_slope: 0x%08x\n", idle_slope);
	printk(KERN_INFO "\thigh_credit: 0x%08x\n", high_credit);
	printk(KERN_INFO "\tlow_credit: 0x%08x\n", low_credit);
