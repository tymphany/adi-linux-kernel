...
#define CTL_STAT_OFFSET              0x00000000     /*!< Packet Engine Control Register */
#define SRC_ADDR_OFFSET              0x00000004     /*!< Packet Engine Source Address */
#define DEST_ADDR_OFFSET             0x00000008     /*!< Packet Engine Destination Address */
#define SA_ADDR_OFFSET               0x0000000C     /*!< Packet Engine SA Address */
#define STATE_ADDR_OFFSET            0x00000010     /*!< Packet Engine State Record Address */
#define ARC4STATE_ADDR_OFFSET        0x00000014     /*!< Packet Engine ARC4 State Record Address */
#define USERID_OFFSET                0x00000018     /*!< Packet Engine User ID */
#define LEN_OFFSET                   0x0000001C     /*!< Packet Engine Length Register */
#define CDRBASE_ADDR_OFFSET          0x00000080     /*!< Packet Engine Command Descriptor Ring Base Address */
#define RDRBASE_ADDR_OFFSET          0x00000084     /*!< Packet Engine Result Descriptor Ring Base Address */
#define RING_CFG_OFFSET              0x00000088     /*!< Packet Engine Ring Configuration */
#define RING_THRESH_OFFSET           0x0000008C     /*!< Packet Engine Ring Threshold Registers */
#define CDSC_CNT_OFFSET              0x00000090     /*!< Packet Engine Command Descriptor Count Register */
#define CDSC_INCR_OFFSET             0x00000090     /*!< Packet Engine Command Descriptor Count Increment Register */
#define RDSC_CNT_OFFSET              0x00000094     /*!< Packet Engine Result Descriptor Count Registers */
#define RDSC_DECR_OFFSET             0x00000094     /*!< Packet Engine Result Descriptor Count Decrement Registers */
#define RING_PTR_OFFSET              0x00000098     /*!< Packet Engine Ring Pointer Status */
#define RING_STAT_OFFSET             0x0000009C     /*!< Packet Engine Ring Status */
#define CFG_OFFSET                   0x00000100     /*!< Packet Engine Configuration Register */
#define STAT_OFFSET                  0x00000104     /*!< Packet Engine Status Register */
#define BUF_THRESH_OFFSET            0x0000010C     /*!< Packet Engine Buffer Threshold Register */
#define INBUF_CNT_OFFSET             0x00000110     /*!< Packet Engine Input Buffer Count Register */
#define INBUF_INCR_OFFSET            0x00000110     /*!< Packet Engine Input Buffer Count Increment Register */
#define OUTBUF_CNT_OFFSET            0x00000114     /*!< Packet Engine Output Buffer Count Register */
#define OUTBUF_DECR_OFFSET           0x00000114     /*!< Packet Engine Output Buffer Count Decrement Register */
#define BUF_PTR_OFFSET               0x00000118     /*!< Packet Engine Buffer Pointer Register */
#define DMA_CFG_OFFSET               0x00000120     /*!< Packet Engine DMA Configuration Register */
#define ENDIAN_CFG_OFFSET            0x000001D0     /*!< Packet Engine Endian Configuration Register */
#define HLT_CTL_OFFSET               0x000001E0     /*!< Packet Engine Halt Control Register */
#define HLT_STAT_OFFSET              0x000001E0     /*!< Packet Engine Halt Status Register */
...
#define STATE_IV_OFFSET(x)       (0x00000500 + x*4) /*!< State Initialization Vector Registers */
...
#define ARC4STATE_BUF_OFFSET        0x00000700      /*!< Starting Entry of 256-byte ARC4 State Buffer */
#define DATAIO_BUF_OFFSET           0x00000800      /*!< Starting Entry of 256-byte Data Input/Output Buffer */ 
...
#define ENUM_PKTE_CFG_TCM0                   0x00000100    /*  MODE: Target Command Mode with Result Descriptor Ring Disabled. */
#define ENUM_PKTE_CFG_TCM1                   0x00000200    /*  MODE: Target Command Mode with Result Descriptor Ring Enabled. */
...
#define BITM_PKTE_SA_CMD1_HMAC               0x00001000    /*  Keyed-Hash SSL Message Authentication Code */
...
typedef enum {
    ...
    /*! Generic failure. */
    ADI_PKTE_FAILURE,
    /*! The given mode of operation is invalid. */
    ADI_PKTE_MODE_ERROR,
    /*! The given device instance number is invalid. */
    ADI_PKTE_INVALID_DEVICE_NUM,
    /*! The CDR ring overflow error has occurred. */
    ADI_PKTE_CDR_OVERFLOW_ERROR,
    /*! The RDR ring underflow error has occurred. */
    ADI_PKTE_RDR_UNDERFLOW_ERROR,
    /*! The processor error has occurred. */
    ADI_PKTE_PROC_ERROR,
    /*! The given PKTE handle is NULL or invalid. */
    ADI_PKTE_INVALID_HANDLE,
    /*! The given PKTE device is not initialized */
    ADI_PKTE_NOT_OPENED,
    /*! The given PKTE device instance is already opened. */
    ADI_PKTE_ALREADY_OPENED,
    /*! The given pointer is invalid or NULL. */
    ADI_PKTE_NULL_POINTER,
    /*! The given parameter is not in the valid range. */
    ADI_PKTE_INVALID_PARAMETER,
    /*! The given amount memory is insufficient for the given mode of operation. */
    ADI_PKTE_INSUFFICIENT_MEMORY,
    /*! Failed to register or unregister an interrupt handler with interrupt service. */
    ADI_PKTE_INT_FAILED,
    /*! Semaphore related failure occurred */
    ADI_PKTE_SEM_FAILED,
    /*! Invalid operation which should not be allowed */
    ADI_PKTE_OPERATION_NOT_ALLOWED,
