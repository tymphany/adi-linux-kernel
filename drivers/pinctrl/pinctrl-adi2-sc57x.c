/*
 * Pinctrl Driver for ADI SC57X SOC
 *
...
static const unsigned eth0_pins[] = {
	GPIO_PB7, GPIO_PB8, GPIO_PA11, GPIO_PA10, GPIO_PA13, GPIO_PA12,
	GPIO_PB0, GPIO_PB1, GPIO_PA14, GPIO_PA15, GPIO_PB9, GPIO_PB4,
	GPIO_PB6, GPIO_PB5,
};
...
static const unsigned eth0_ptp_pins[] = {
	GPIO_PB7, GPIO_PB8, GPIO_PA11, GPIO_PA10, GPIO_PA13, GPIO_PA12,
	GPIO_PB0, GPIO_PB1, GPIO_PA14, GPIO_PA15, GPIO_PB9, GPIO_PB4,
	GPIO_PB6, GPIO_PB5, GPIO_PE1, GPIO_PE0, GPIO_PD8,
	GPIO_PA9, GPIO_PF5, GPIO_PD14,
};
...
static const unsigned spi1_pins[] = {
	GPIO_PC7, GPIO_PC8, GPIO_PC9,
};

static const unsigned spi2_pins[] = {
	GPIO_PB14, GPIO_PB10, GPIO_PB11,
};

static const unsigned spi2_quad_pins[] = {
	GPIO_PB14, GPIO_PB10, GPIO_PB11, GPIO_PB12, GPIO_PB13,
};
...
static const unsigned lp0_pins[] = {
	GPIO_PE4, GPIO_PE5, GPIO_PE6, GPIO_PE7, GPIO_PE8, GPIO_PE9,
	GPIO_PE10, GPIO_PE11, GPIO_PE2, GPIO_PE3,
};

static const unsigned lp1_pins[] = {
	GPIO_PD10, GPIO_PD11, GPIO_PD12, GPIO_PD13, GPIO_PD14, GPIO_PD15,
	GPIO_PA9, GPIO_PD9, GPIO_PB3, GPIO_PB1,
};

static const unsigned ppi0_8b_pins[] = {
	GPIO_PC11, GPIO_PC14, GPIO_PC15, GPIO_PC6,
	GPIO_PD10, GPIO_PD11, GPIO_PD12, GPIO_PD13, GPIO_PD14, GPIO_PD15,
	GPIO_PC5, GPIO_PD9,
};
...
static const unsigned ppi0_16b_pins[] = {
	GPIO_PC11, GPIO_PC14, GPIO_PC15, GPIO_PC6,
	GPIO_PD10, GPIO_PD11, GPIO_PD12, GPIO_PD13, GPIO_PD14, GPIO_PD15,
	GPIO_PC5, GPIO_PD9, GPIO_PC1, GPIO_PC2, GPIO_PC3, GPIO_PC4,
	GPIO_PE0, GPIO_PC7, GPIO_PC8, GPIO_PE1,
};

static const unsigned mmc0_pins[] = {
	GPIO_PE12, GPIO_PE13, GPIO_PE14, GPIO_PE15, GPIO_PF0, GPIO_PF1,
...
static const unsigned short mmc0_mux[] = {
...
static const char * const ppi0grp[] = { "ppi0_8bgrp", "ppi0_16bgrp" };
