...
/**
 * mcapi stuff to remove once i'm sure it isn't called by anything the sc598 builds
 */
...
/**
 * This doesn't even make sense because the cpumask only reflects cpus that
 * are tracked by linux and does not include remoteproc cores
 */
