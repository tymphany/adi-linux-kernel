...
#define PORTH_FER         0x31004380
#define PORTI_FER         0x31004400
...
/* UART Port Mux */
#define P_UART0_TX      (P_DEFINED | P_IDENT(GPIO_PA6) | P_FUNCT(1))
#define P_UART0_RX      (P_DEFINED | P_IDENT(GPIO_PA7) | P_FUNCT(1))
#define P_UART0_RTS     (P_DEFINED | P_IDENT(GPIO_PA8) | P_FUNCT(1))
#define P_UART0_CTS     (P_DEFINED | P_IDENT(GPIO_PA9) | P_FUNCT(1))

#define P_UART1_TX      (P_DEFINED | P_IDENT(GPIO_PD5) | P_FUNCT(0))
#define P_UART1_RX      (P_DEFINED | P_IDENT(GPIO_PD4) | P_FUNCT(0))
...
#define P_OSPI0_D4      (P_DEFINED | P_IDENT(GPIO_PD0)  | P_FUNCT(0))
#define P_OSPI0_D5      (P_DEFINED | P_IDENT(GPIO_PC15) | P_FUNCT(0))
#define P_OSPI0_D6      (P_DEFINED | P_IDENT(GPIO_PC14) | P_FUNCT(0))
#define P_OSPI0_D7      (P_DEFINED | P_IDENT(GPIO_PC13) | P_FUNCT(0))
#define P_OSPI0_DQS     (P_DEFINED | P_IDENT(GPIO_PD4)  | P_FUNCT(2))
...
#define P_SPI2_MOSI     (P_DEFINED | P_IDENT(GPIO_PA1) | P_FUNCT(0))
#define P_SPI2_D2       (P_DEFINED | P_IDENT(GPIO_PA2) | P_FUNCT(0))
#define P_SPI2_D3       (P_DEFINED | P_IDENT(GPIO_PA3) | P_FUNCT(0))
...
/* Linkport Port Mux */
#define P_LP0_D0            (P_DEFINED | P_IDENT(GPIO_PB7) | P_FUNCT(0))
#define P_LP0_D1            (P_DEFINED | P_IDENT(GPIO_PB8) | P_FUNCT(0))
#define P_LP0_D2            (P_DEFINED | P_IDENT(GPIO_PB9) | P_FUNCT(0))
#define P_LP0_D3            (P_DEFINED | P_IDENT(GPIO_PB10) | P_FUNCT(0))
#define P_LP0_D4            (P_DEFINED | P_IDENT(GPIO_PB11) | P_FUNCT(0))
#define P_LP0_D5            (P_DEFINED | P_IDENT(GPIO_PB12) | P_FUNCT(0))
#define P_LP0_D6            (P_DEFINED | P_IDENT(GPIO_PB13) | P_FUNCT(0))
#define P_LP0_D7            (P_DEFINED | P_IDENT(GPIO_PB14) | P_FUNCT(0))
#define P_LP0_CLK           (P_DEFINED | P_IDENT(GPIO_PB6) | P_FUNCT(0))
#define P_LP0_ACK           (P_DEFINED | P_IDENT(GPIO_PB4) | P_FUNCT(0))

#define P_LP1_D0            (P_DEFINED | P_IDENT(GPIO_PB15) | P_FUNCT(0))
#define P_LP1_D1            (P_DEFINED | P_IDENT(GPIO_PC0) | P_FUNCT(0))
#define P_LP1_D2            (P_DEFINED | P_IDENT(GPIO_PC1) | P_FUNCT(0))
#define P_LP1_D3            (P_DEFINED | P_IDENT(GPIO_PC2) | P_FUNCT(0))
#define P_LP1_D4            (P_DEFINED | P_IDENT(GPIO_PC3) | P_FUNCT(0))
#define P_LP1_D5            (P_DEFINED | P_IDENT(GPIO_PC4) | P_FUNCT(0))
#define P_LP1_D6            (P_DEFINED | P_IDENT(GPIO_PC5) | P_FUNCT(0))
#define P_LP1_D7            (P_DEFINED | P_IDENT(GPIO_PC6) | P_FUNCT(0))
#define P_LP1_CLK           (P_DEFINED | P_IDENT(GPIO_PC7) | P_FUNCT(0))
#define P_LP1_ACK           (P_DEFINED | P_IDENT(GPIO_PB2) | P_FUNCT(0))

/* EMAC RETH Port Mux */
#define P_ETH0_TXD0	  (P_DEFINED | P_IDENT(GPIO_PH9) | P_FUNCT(0))
#define P_ETH0_TXD1	  (P_DEFINED | P_IDENT(GPIO_PH10) | P_FUNCT(0))
#define P_ETH0_MDC	  (P_DEFINED | P_IDENT(GPIO_PH3) | P_FUNCT(0))
#define P_ETH0_MDIO	  (P_DEFINED | P_IDENT(GPIO_PH4) | P_FUNCT(0))
#define P_ETH0_RXD0	  (P_DEFINED | P_IDENT(GPIO_PH5) | P_FUNCT(0))
#define P_ETH0_RXD1	  (P_DEFINED | P_IDENT(GPIO_PH6) | P_FUNCT(0))
#define P_ETH0_RXCLK  (P_DEFINED | P_IDENT(GPIO_PH7) | P_FUNCT(0))
#define P_ETH0_CRS	  (P_DEFINED | P_IDENT(GPIO_PH8) | P_FUNCT(0))
#define P_ETH0_RXD2	  (P_DEFINED | P_IDENT(GPIO_PH11) | P_FUNCT(0))
#define P_ETH0_RXD3	  (P_DEFINED | P_IDENT(GPIO_PH12) | P_FUNCT(0))
#define P_ETH0_TXEN	  (P_DEFINED | P_IDENT(GPIO_PH13) | P_FUNCT(0))
#define P_ETH0_TXCLK  (P_DEFINED | P_IDENT(GPIO_PH14) | P_FUNCT(0))
#define P_ETH0_TXD2	  (P_DEFINED | P_IDENT(GPIO_PH15) | P_FUNCT(0))
#define P_ETH0_TXD3	  (P_DEFINED | P_IDENT(GPIO_PI0) | P_FUNCT(0))
...
#define P_ETH1_CRS	(P_DEFINED | P_IDENT(GPIO_PF3) | P_FUNCT(0))
#define P_ETH1_MDC	(P_DEFINED | P_IDENT(GPIO_PF2) | P_FUNCT(0))
#define P_ETH1_MDIO	(P_DEFINED | P_IDENT(GPIO_PF1) | P_FUNCT(0))
#define P_ETH1_TXCLK	(P_DEFINED | P_IDENT(GPIO_PE11) | P_FUNCT(0))
#define P_ETH1_TXEN	(P_DEFINED | P_IDENT(GPIO_PE12) | P_FUNCT(0))
#define P_ETH1_TXD0	(P_DEFINED | P_IDENT(GPIO_PE13) | P_FUNCT(0))
#define P_ETH1_TXD1	(P_DEFINED | P_IDENT(GPIO_PE14) | P_FUNCT(0))
#define P_ETH1_RXD0	(P_DEFINED | P_IDENT(GPIO_PE15) | P_FUNCT(0))
#define P_ETH1_RXD1	(P_DEFINED | P_IDENT(GPIO_PF0) | P_FUNCT(0))
