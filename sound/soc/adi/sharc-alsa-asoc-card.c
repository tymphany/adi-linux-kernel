...
static int sharc_alsa_pcm_hw_params(struct snd_soc_component *component,
...
static int sharc_alsa_pcm_hw_free(struct snd_soc_component *component,
	struct snd_pcm_substream *substream)
{
...
static snd_pcm_uframes_t sharc_alsa_pcm_pointer(struct snd_soc_component *component,
	struct snd_pcm_substream *substream)
{
...
static int sharc_alsa_pcm_open(struct snd_soc_component *component,
	struct snd_pcm_substream *substream)
{
...
static int sharc_alsa_pcm_prepare(struct snd_soc_component *component,
	struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct sharc_alsa_card_data *sharc_alsa = runtime->private_data;
...
static int sharc_alsa_pcm_trigger(struct snd_soc_component *component,
...
static int sharc_alsa_pcm_new(struct snd_soc_component *component,
...
static void sharc_alsa_delayed_probe(struct work_struct *work)
{
	...
	for (i = 0; i < subdev_num; i++) {
		...
		sharc_alsa_component.component_driver.name = sharc_alsa_component.component_driver_name;
		sharc_alsa_component.component_driver.open = sharc_alsa_pcm_open;
		sharc_alsa_component.component_driver.hw_params = sharc_alsa_pcm_hw_params;
		sharc_alsa_component.component_driver.hw_free = sharc_alsa_pcm_hw_free;
		sharc_alsa_component.component_driver.prepare = sharc_alsa_pcm_prepare;
		sharc_alsa_component.component_driver.trigger = sharc_alsa_pcm_trigger;
		sharc_alsa_component.component_driver.pointer = sharc_alsa_pcm_pointer;
		sharc_alsa_component.component_driver.pcm_construct = sharc_alsa_pcm_new;
