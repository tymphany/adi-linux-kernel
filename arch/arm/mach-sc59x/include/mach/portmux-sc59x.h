...
#define P_SPI1_SCK      (P_DEFINED | P_IDENT(GPIO_PA10) | P_FUNCT(0))
#define P_SPI1_MISO     (P_DEFINED | P_IDENT(GPIO_PA11) | P_FUNCT(0))
#define P_SPI1_MOSI     (P_DEFINED | P_IDENT(GPIO_PA12) | P_FUNCT(0))
